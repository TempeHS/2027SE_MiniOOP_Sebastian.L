...
## Read an analogue sensor and control the LEDs' brightness
...
The PWM is a technique that allows the generation of a voltage between 0 and 3.3V using only digital outputs. PWM is the acronym for Pulse Width Modulation. Indeed, this trick is based on the temporal proportion of a logic signal at its high state (3.3V) and its low state (0V): the PWM consists of varying the width of an electrical pulse.
